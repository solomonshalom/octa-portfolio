...
I was recently looking for ways [to automate sharing code snippets](https://twitter.com/avbethel/status/1263110355666046977), I thought that generating these code snippets images by calling a serverless function could be a pretty cool use case to apply some of the serverless concepts and tricks I've learned the past few months.
...
- To generate images for my meta tags for some articles or snippets (I already do this now 👉 https://twitter.com/avbethel/status/1263855151695175680)
