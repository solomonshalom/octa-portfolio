...
Over the past few months, Framer Motion went from being a fun tool I played with on the side to a core element of my frontend projects when it comes to adding a layer of interaction to my UIs. I went **from knowing almost nothing about animations and transitions**, to being able [to orchestrate more complex animations](https://twitter.com/avbethel/status/1327647479521701889?s=20) involving lots of elements.
