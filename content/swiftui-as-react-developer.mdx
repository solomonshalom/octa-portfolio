...
class User {
    var username = "@avbethel"
}

struct ContentView: View {
    @State private var user = User()
    @State private var username = "@avbethel"
