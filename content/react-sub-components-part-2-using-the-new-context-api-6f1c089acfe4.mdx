...
_To fully understand this post, please read_ [_my original post about React sub-components_](https://medium.com/@avbethel/react-sub-components-513f6679abed) _first._
