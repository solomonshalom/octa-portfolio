...
What makes it unique compared to other apps was the asset I built (sun, clouds, rain), the focus on the UX, and the little animations sprinkled across the interface. Although challenging, I tried to stand by these principles from [the prototyping phase](https://twitter.com/avbethel/status/1302712443039371265) and throughout the development of this app.
